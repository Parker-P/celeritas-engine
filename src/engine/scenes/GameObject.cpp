...
namespace Engine::Scenes
{
	...
	std::vector<Vulkan::DescriptorSet> GameObject::CreateShaderResources(Vulkan::PhysicalDevice& physicalDevice, VkDevice& logicalDevice, VkCommandPool& commandPool, Vulkan::Queue& graphicsQueue)
	{
		...
		_sets.push_back(DescriptorSet{ 1, descriptorSet, layout });
		return _sets;
	}
