...
namespace Engine
{
	...
	// End included file: structural/IUpdatable.hpp
	// Begin included file: structural/IPhysicsUpdatable.hpp
	...
	// End included file: structural/IPhysicsUpdatable.hpp
	// Begin included file: structural/Singleton.hpp
	...
	{
	public:
		std::vector<Material> LoadMaterials(VkDevice& logicalDevice, VkPhysicalDevice& physicalDevice, tinygltf::Model& gltfScene)
		{
	...
	std::vector<DescriptorSetLayout> VulkanApplication::CreateDescriptorSetLayouts()
	{
